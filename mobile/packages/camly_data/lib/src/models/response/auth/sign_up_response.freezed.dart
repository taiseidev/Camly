...
class _$SignUpResponseImpl implements _SignUpResponse {
  ...
  @override
  String toString() {
    return 'SignUpResponse(accessToken: $accessToken, refreshToken: $refreshToken, accessTokenExpiration: $accessTokenExpiration, refreshTokenExpiration: $refreshTokenExpiration)';
  }
...
abstract class _SignUpResponse implements SignUpResponse {
  const factory _SignUpResponse(
      ...
      required final String refreshTokenExpiration}) = _$SignUpResponseImpl;
